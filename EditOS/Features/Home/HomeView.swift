...
struct HomeView: View {
    ...
    private var detail: some View {
        ...
        case .recordings:   HomeRecordingsView()
...
// Recordings now live on their own sidebar section (see
// `HomeRecordingsView`). Mixing raw captures with project cards on
// the same page made Home feel cluttered and ambiguous about what
// each tile represented. The Quick Actions row still has "Record
// screen" so the entry point stays one click from Home.
